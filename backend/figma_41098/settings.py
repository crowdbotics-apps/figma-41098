"""
Django settings for figma_41098 project.
...
WSGI_APPLICATION = 'figma_41098.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "figma_41098 API",
    "DESCRIPTION": "API documentation for figma_41098 App",
    "VERSION": "v1",
}
